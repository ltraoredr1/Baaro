...
### Migration 015 — intégrité des récompenses
Les récompenses hors bonus quotidien doivent désormais référencer un événement métier réel (publication, like, commentaire, abonnement, vidéo, story, etc.). Le serveur vérifie cet événement et empêche sa rémunération deux fois.
