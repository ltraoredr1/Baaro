...
// mode="host" : démarre un nouveau live et affiche le code d'invitation.
// mode="guest" : rejoint un live existant via un code déjà saisi.
...
export function DebateRoom({ mode, debate, inviteCode: joinCode, userName, onLeave }) {
