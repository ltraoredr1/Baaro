...
const DEMO_P2P_MESSAGES = [
  { id: "p1", sender: "Amina (Redmi)", text: "Salut ! Message envoyé en P2P direct sans forfait data ni Wi-Fi Internet !", time: "14:32" }
];
...
export function OfflineTab({ onRewardPoints }) {
  ...
  const handleSendP2P = (e) => {
    ...
    setP2pInput("");
    onRewardPoints(2);
    showPointsReward(2, "Message P2P transmis");
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: COLORS.muted }}>Communiquez avec les téléphones BAARO proches sans aucune connexion Internet ni data.</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center pb-3 border-b" style={{ borderColor: COLORS.border }}>
              <span className="text-sm font-bold flex items-center gap-2" style={{ color: COLORS.ivory }}>
                ...
                Canal P2P Local (Chiffré AES-256)
              </span>
