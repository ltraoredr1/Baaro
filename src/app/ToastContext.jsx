...
/**
 * Toasts + correction randomId manquant.
 * Remplace : src/components/ToastContext.jsx
 */
export function ToastProvider({ children }) {
  ...
  const showPointsReward = useCallback(
    (pts, reason) => {
      showToast(`+${pts} pts — ${reason}`, "points", 4500);
    },
    [showToast]
  );
            ...
            style={{
              background:
                toast.type === "points"
                  ...
                  : "rgba(26, 39, 64, 0.95)",
              borderColor:
                toast.type === "points" ? COLORS.gold : "rgba(255,255,255,0.12)",
